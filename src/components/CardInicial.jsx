...
export function CardInicial({ setNotaAvaliacao, handleSubmit, setSubmited}) {
    ...
    return (
      ...
      <p className="text-sm text-light-grey mb-6 leading-1">Please let us know how he did with your support request. All feedback is appreciated to help us improve our offering!</p>
